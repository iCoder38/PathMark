...
//            print(productIDString)
    ...
    @objc func audio_call_click_method() {
        ...
        self.store_data_in_db_before_call()
        // self.send_notification_to_doctor(str_get_type: "audiocall")
        
    }
    
    @objc func store_data_in_db_before_call() {
        ...
        if let person = UserDefaults.standard.value(forKey: "keyLoginFullData") as? [String:Any] {
            ...
            Firestore.firestore().collection(audio_call_collection_path).addDocument(data: [
                ...
                if error != nil {
                    ...
                    // get data now
                     self.manage_data_before_send_notification(getAudioCallId: String(uuid))
                }
            }
    ...
    func manage_data_before_send_notification(getAudioCallId:String) {
