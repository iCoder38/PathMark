...
@interface AddMissingChildEmptyFormVC ()
{
    NSString *Address;
...
@implementation AddMissingChildEmptyFormVC
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [self setTitle:@"Add Child/Person"];
...
-(void)allTextFields
{
    ...
    self.arrIsTheChild=[[NSMutableArray alloc] initWithObjects:@"Is this Person?",@"Lost",@"Missing",@"Runaway",@"Others", nil];
    ...
    UIImageView *imgDownArrowOfGender=[[UIImageView alloc]init];
    UIImageView *imgDownArrowOfDOB=[[UIImageView alloc]init];
    UIImageView *imgDownArrowOfDateOfDisa=[[UIImageView alloc]init];
    UIImageView *imgDownArrowOfTimeOfDisa=[[UIImageView alloc]init];
    
    UIImageView *imgDownArrowOfIsTheChild=[[UIImageView alloc]init];
    UIImageView *imgDownArrowOfLens=[[UIImageView alloc]init];
    UIImageView *imgDownArrowOfLastWearing=[[UIImageView alloc]init];
    ...
    imgDownArrowOfGender.image=[UIImage imageNamed:@"downarrow"];;
    imgDownArrowOfGender.frame=cgFrame(txtGender.frame.size.width-30, 10, 24, 24);
    ...
    imgDownArrowOfDOB.image=[UIImage imageNamed:@"calender"];;
    imgDownArrowOfDOB.frame=cgFrame(txtDOB.frame.size.width-30, 10, 24, 24);
    ...
    imgDownArrowOfLens.image=[UIImage imageNamed:@"downarrow"];;
    imgDownArrowOfLens.frame=cgFrame(txtWearGlassOrContactLens.frame.size.width-30, 10, 24, 24);
    ...
    imgDownArrowOfIsTheChild.image=[UIImage imageNamed:@"downarrow"];;
    imgDownArrowOfIsTheChild.frame=cgFrame(txtIsTheChild.frame.size.width-30, 10, 24, 24);
    ...
    imgDownArrowOfLastWearing.image=[UIImage imageNamed:@"downarrow"];;
    imgDownArrowOfLastWearing.frame=cgFrame(txtTheChildWasLastSeendWearing.frame.size.width-30, 10, 24, 24);
...
//    [Alert textFieldplaceholder:txtComplaintDate frame:cgFrame(xPos, txtTheChildWasLastSeendWearing.frame.size.height + txtTheChildWasLastSeendWearing.frame.origin.y + yPos, kSCREEN_WIDTH-40, heights) placeholder:@"Date Alert Issued" textColor:txtColor font:ml16 bg:bgColor cornerRadius:4 paddingValue:20 yesNo:YES];
    ...
    imgDownArrowOfDateOfDisa.image=[UIImage imageNamed:@"calender"];;
    imgDownArrowOfDateOfDisa.frame=cgFrame(txtDateOfDisapearance.frame.size.width-30, 10, 24, 24);
...
//add subview
    ...
    [txtGender addSubview:imgDownArrowOfGender];
    [viewOnScroll addSubview:txtDOB];
    [txtDOB addSubview:imgDownArrowOfDOB];
    [viewOnScroll addSubview:txtDateOfDisapearance];
    [txtDateOfDisapearance addSubview:imgDownArrowOfDateOfDisa];
    ...
    [txtWearGlassOrContactLens addSubview:imgDownArrowOfLens];
    ...
    [txtTheChildWasLastSeendWearing addSubview:imgDownArrowOfLastWearing];
    [viewOnScroll addSubview:txtIsTheChild];
    [txtIsTheChild addSubview:imgDownArrowOfIsTheChild];
    ...
    txtPinCode.keyboardType = UIKeyboardTypeDefault;
    ...
    txtFatherName.keyboardAppearance = UIKeyboardAppearanceDark;
    txtMotherName.keyboardAppearance = UIKeyboardAppearanceDark;
    txtPinOrZipCode.keyboardAppearance = UIKeyboardAppearanceDark;
    
    txtPrizeReward.keyboardAppearance = UIKeyboardAppearanceDark;
    txtPrizeReward.keyboardType = UIKeyboardTypePhonePad;

    
    txtAnySuspicion.keyboardAppearance = UIKeyboardAppearanceDark;
    txtTheChildWasLastSeendWearing.keyboardAppearance = UIKeyboardAppearanceDark;
        ...
        if(textField==txtColorOfHair)
        {
            ...
            if(textField==txtColourOfEyes)
            {
                ...
                if(textField==txtWearGlassOrContactLens)
                {
                    ...
                    {
                        [pickerGender selectRow:[self.arrLensYesOrNo indexOfObject:txtWearGlassOrContactLens.text] inComponent:0 animated:NO];
                    }
                }
...
-(void)whenUserClickSaveDraftWebserviceWithNotForMultiPart
{
    ...
    parameters = @{
                   ...
                   @"is_wear_glasses_lens"  : txtTheChildWasLastSeendWearing.text,
                   ...
                   @"latitude"              : @"",
                   @"prize_money"             : txtPrizeReward.text,
                   @"prize_msg"             : txtRewardInformation.text,
