//
//  MakeFullFormOfSavedDetailsVC.h
//  OWL
//
...
@interface MakeFullFormOfSavedDetailsVC : UIViewController
<
UITextFieldDelegate,
...
@property (strong,nonatomic)NSDictionary *dictGetAllValueOfClickedSavedChild;
@end
