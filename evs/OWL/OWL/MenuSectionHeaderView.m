...
-(void)openAnimated:(BOOL)animated {
    ...
    if (animated && !isRotating) {
        ...
        [UIView animateWithDuration:0.0 delay:0.0 options: UIViewAnimationOptionAllowUserInteraction |UIViewAnimationOptionCurveEaseIn animations:^{
...
-(void)closeAnimated:(BOOL)animated {
    ...
    if (animated && !isRotating) {
        ...
        [UIView animateWithDuration:0.0 delay:0.0 options: UIViewAnimationOptionAllowUserInteraction |UIViewAnimationOptionCurveEaseOut animations:^{
