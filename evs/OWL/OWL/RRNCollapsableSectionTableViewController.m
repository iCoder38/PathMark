...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    UIImageView *img = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, kSCREEN_WIDTH, 60)];
    if (section % 2 == 0)
    {
        img.backgroundColor = [UIColor colorWithRed:245.0/255.0 green:245.0/255.0 blue:245.0/255.0 alpha:1];
    }
    else
    {
        
        img.backgroundColor = [UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:245.0/255.0 alpha:1];
        
    }
    
    UIImageView *imgPlus = [[UIImageView alloc]initWithFrame:CGRectMake(kSCREEN_WIDTH-40, 16, 24, 24)];
   // imgPlus.image = [UIImage imageNamed:@"rightA"];
    
    UILabel *lblText = [[UILabel alloc]initWithFrame:CGRectMake(10, 0, kSCREEN_WIDTH, 60)];
    lblText.numberOfLines=0;
    lblText.lineBreakMode = NSLineBreakByWordWrapping;
    //lblText.font = [UIFont fontWithName:fontRegular size:14.0];
    ...
    view.tag = section;
    view.backgroundColor =[UIColor colorWithRed:40.0/255.0 green:40.0/255.0 blue:40.0/255.0 alpha:1.0];
...
//    }
    ...
    if (headerConforms && itemConforms) {
        ...
        lblText.text =((id <RRNCollapsableSectionItemProtocol>)menuSection).title;
    }
    [view addSubview:img];
